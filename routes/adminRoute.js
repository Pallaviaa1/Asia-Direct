...
admin_route.post('/add-freight', upload.fields([{ name: 'Customs Documents', maxCount: 5 }, { name: 'Waybills', maxCount: 5 }, { name: 'Supporting Documents', maxCount: 5 }, { name: 'Invoice, Packing List', maxCount: 5 },
{ name: 'Product Literature', maxCount: 5 }, { name: 'Letters of authority', maxCount: 5 }, { name: 'AD_Quotations', maxCount: 5 }, { name: 'Supplier Invoices', maxCount: 5 }]), adminController.Addfreight);
admin_route.post('/freight-list', adminController.GetFreightAdmin);
admin_route.post('/freight-list-byId', adminController.GetFreightAdminById);
admin_route.post('/new-freight-list', adminController.GetFreightCustomer);
admin_route.post('/edit-freight', upload.fields([{ name: 'Customs Documents', maxCount: 5 }, { name: 'Waybills', maxCount: 5 }, { name: 'Supporting Documents', maxCount: 5 }, { name: 'Invoice, Packing List', maxCount: 5 },
{ name: 'Product Literature', maxCount: 5 }, { name: 'Letters of authority', maxCount: 5 }, { name: 'AD_Quotations', maxCount: 5 }, { name: 'Supplier Invoices', maxCount: 5 }]), adminController.EditFreight);
...
admin_route.post('/country-list', adminController.getCountryOriginList);
...
admin_route.post('/addEstimateShippingQuote', adminController.addEstimateShippingQuote);
admin_route.post('/GetQuoteShipEstimateById', adminController.GetQuoteShipEstimateById);
admin_route.post('/GetQuoteShipEstimateBySupplier', adminController.GetQuoteShipEstimateBySupplier);

admin_route.post('/shipping_estimate', upload.single('Supplier_Quote_Attachment'), adminController.Shipping_Estimate);
admin_route.post('/Shipping_Estimate_supplier', adminController.Shipping_Estimate_supplier)
...
admin_route.post('/GetShipEstimateSupplierId', adminController.GetShipEstimateSupplierId);
admin_route.post('/ApproveShippingEstimate', adminController.ApproveShippingEstimate);
admin_route.post('/delete-shipestimate', adminController.DeleteShipEstimate);

admin_route.post('/send-notification', upload.array("document", 10), adminController.SendNotification);
...
admin_route.post('/assignWarehouseSupplierToOrder', adminController.assignWarehouseSupplierToOrder);
admin_route.post('/getAllAssignedOrdersToWarehouse', adminController.getAllAssignedOrdersToWarehouse);
admin_route.post('/getAllAssignedOrderBySupplier', adminController.getAllAssignedOrdersToWarehouseBySupplier);
...
admin_route.post('/assignWarehouseOrderToSupplier', adminController.assignWarehouseOrderToSupplier)
admin_route.post('/getAssignedOrdersBySupplier', adminController.getAssignedOrdersBySupplier)
...
admin_route.post('/getAllBatch', adminController.getAllBatch)
admin_route.post('/NewGetAllBatch', adminController.NewGetAllBatch)
...
admin_route.post("/getClerance", adminController.getClerance)
...
admin_route.post("/getWarehouseBySupplierId", adminController.getWarehouseBySupplierId)
admin_route.post("/DeleteWarehouse", adminController.DeleteWarehouse)
admin_route.post("/editWarehouseDetails", upload.fields([{ name: "Warehouse Entry Docs", maxCount: 5 }, { name: 'Waybills', maxCount: 5 }, { name: 'Supporting Documents', maxCount: 5 }, { name: 'Invoice, Packing List', maxCount: 5 },
{ name: 'Product Literature', maxCount: 5 }, { name: 'Letters of authority', maxCount: 5 }, { name: 'AD_Quotations', maxCount: 5 }, { name: 'Supplier Invoices', maxCount: 5 }]), adminController.editWarehouseDetails)
...
admin_route.post("/addWarehouseProduct", upload.fields([{ name: 'Warehouse Entry Docs', maxCount: 5 }, { name: 'Waybills', maxCount: 5 }, { name: 'Supporting Documents', maxCount: 5 }, { name: 'Invoice, Packing List', maxCount: 5 },
{ name: 'Product Literature', maxCount: 5 }, { name: 'Letters of authority', maxCount: 5 }, { name: 'AD_Quotations', maxCount: 5 }, { name: 'Supplier Invoices', maxCount: 5 }]), adminController.addWarehouseProduct)
...
admin_route.post("/getWarehouseProductById", adminController.getWarehouseProductById)
...
admin_route.post("/updateWareHouseProductBySupplier", adminController.updateWareHouseProductBySupplier)
...
admin_route.get("/createFreightFolders", adminController.createFreightFolders)
